...
<html>
  ...
  <body>
    ...
    <ul>
      ...
      <li><a href="dossier_liste.php">Liste des dossiers</a></li>
      ...
      <li><a href="global_telechargement.php">Téléchargements du site</a></li>
      <li><a href="contenu_generique.php">Page de contenu générique (sans sidebar)</a></li>
      <li><a href="recherche_resultats.php">Résultats de recherche</a></li>
    </ul>
  </body>
</html>